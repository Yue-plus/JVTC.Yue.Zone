    ...
    return Index([
        {
            icon: "supabase.svg",
            title: "Supabase",
            text: "开源开发平台，基于 PostgreSQL，集成数据库、身份验证、文件存储、实时订阅等功能于一体",
            href: "/docs/开发/环境/Supabase/"
        },
        {
            icon: "PostgreSQL.svg",
            title: "PostgreSQL",
...
export function DevelopSoftwareBlockChainsIndex() {
    return Index([
        ...
        { icon: "Sui.svg", title: "Sui", text: "通过 Web2 的便捷性为用户提供 Web3 的优势", href: "/docs/开发/软件/区块链/Sui/" },
